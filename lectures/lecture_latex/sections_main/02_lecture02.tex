...
\item useful series: the matrix exponential, sine, and cosine;
\item frames, notation, and transformations;
\item defining rotation: Euler angles and infinitesimal rotations;
\item axis--angle, Rodrigues' formula, and the logarithmic map;
\item $SO(3)$ kinematics: derivatives, integration, interpolation, and the right/left Jacobians;
\item matrix Lie groups: $SO(3)$, $SE(3)$, and $SE_2(3)$ --- error states, adjoints, and more operations;
\item quaternions: product, rotating a vector, derivative, and integration.
\end{itemize}
