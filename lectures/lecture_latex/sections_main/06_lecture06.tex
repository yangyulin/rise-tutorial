...
\paragraph{Topics.} (1) the MAP problem behind the Kalman filter; (2) linearization of the MAP problem; (3) Solution 1: solve it incrementally --- the (E)KF; (4) Solution 2: solve it by batch; (5) discussion: the EKF, MLE/MAP, and the VINS system; (6) visual-inertial initialization; (7) the EKF summary for the VINS; (8) observability analysis.
