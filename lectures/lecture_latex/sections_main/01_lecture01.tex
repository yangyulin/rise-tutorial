...
\subsubsection{A set of random variables}
...
\subsubsection{Gaussian vector pdf}
\begin{align}
...
\subsubsection{Output sequence and observability}
...
\subsubsection{Full LTV solution}
...
\subsubsection{Covariance matrix identity}
...
\subsubsection{Scalar covariance identity}
...
\subsubsection{Independence versus uncorrelatedness}
...
\subsubsection{The \texorpdfstring{$\chi^2$}{chi-squared} distribution}
