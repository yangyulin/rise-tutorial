...
\item camera measurements;
\item essential matrix / triangulation;
\item point / line / plane representations.
\end{itemize}
...
\begin{tikzpicture}[>=stealth,scale=1.05]
  ...
  \fill[red] (O) circle (1.4pt); \node[below] at (O) {$\{C\}$};
  % image plane (tilted parallelogram)
  \draw[blue,thick] (1.25,0.40) -- (2.25,0.72) -- (2.45,2.05) -- (1.45,1.73) -- cycle;
  % sight rays {C} -> image plane -> 3D line L (so {C}, l-point, L-point are collinear)
  \coordinate (la) at (1.90,1.01); \coordinate (lb) at (1.75,1.64);
  \coordinate (LA) at (3.90,1.70); \coordinate (LB) at (3.20,2.70);
  \draw[red] (O) -- (la); \draw[red] (O) -- (lb);
  \draw[red,dotted,thick] (la) -- (LA); \draw[red,dotted,thick] (lb) -- (LB);
  % projected image line l (the intersection of the (C,L) plane with the image plane)
  \draw[red,very thick] (la) -- (lb);
  \node[red,left=1pt] at (1.78,1.30) {\footnotesize $\vect{l}$};
  % the 3D line L
  \draw[red,very thick] (LA) -- (LB);
  \node[black,below right] at (LA) {$L$};
  % normal n_e of the interpretation plane (perpendicular to L)
  \coordinate (M) at (3.55,2.20);
  \draw[->,thick] (M) -- ($(M)+(0.74,0.52)$) node[above] {$\vect{n}_e$};
  \draw ($(M)+(0.139,0.097)$) -- ($(M)+(0.042,0.236)$) -- ($(M)+(-0.097,0.139)$);
\end{tikzpicture}
...
\begin{tikzpicture}[>=stealth,scale=0.92]
  % camera centres
  \coordinate (C1) at (0,0); \fill[red] (C1) circle (1.4pt); \node[below] at (C1) {$\{C_1\}$};
  \coordinate (C2) at (7.0,0); \fill[red] (C2) circle (1.4pt); \node[below] at (C2) {$\{C_2\}$};
  % the single shared 3D line L (centre) with direction v_e
  \coordinate (La) at (3.42,2.30); \coordinate (Lb) at (3.58,3.00);
  \draw[red,very thick] (La) -- (Lb);
  \node[black,below] at (3.46,2.22) {$L$};
  \draw[->,thick,blue] (3.50,2.62) -- (3.64,3.25) node[above] {$\vect{v}_e$};
  % per-camera interpretation-plane normals (n_e perpendicular to the plane edge), with right-angle marks
  \draw (2.74,2.50) -- (3.14,2.66);                                   % left plane edge
  \draw[->,thick] (2.94,2.58) -- ($(2.94,2.58)+(-0.19,0.52)$) node[above left] {\footnotesize ${}^{C_1}\vect{n}_e$};
  \draw ($(2.94,2.58)+(0.150,0.056)$) -- ($(2.94,2.58)+(0.094,0.206)$) -- ($(2.94,2.58)+(-0.056,0.150)$);
  \draw (3.86,2.66) -- (4.26,2.50);                                   % right plane edge
  \draw[->,thick] (4.06,2.58) -- ($(4.06,2.58)+(0.19,0.52)$) node[above right] {\footnotesize ${}^{C_2}\vect{n}_e$};
  \draw ($(4.06,2.58)+(-0.150,0.056)$) -- ($(4.06,2.58)+(-0.094,0.206)$) -- ($(4.06,2.58)+(0.056,0.150)$);
  % image planes (tilted) near each camera
  \draw[blue,thick] (1.05,0.55) -- (1.70,0.78) -- (1.55,1.60) -- (0.90,1.37) -- cycle;
  \draw[blue,thick] (5.30,0.78) -- (5.95,0.55) -- (6.10,1.37) -- (5.45,1.60) -- cycle;
  % sight rays {C1} -> image plane -> L, with the projected image line (blue) on the plane
  \draw[red,dotted] (C1) -- (La); \draw[red,dotted] (C1) -- (Lb);
  \draw[blue,very thick] (1.40,0.93) -- (1.22,1.04);
  % sight rays {C2} -> image plane -> L
  \draw[red,dotted] (C2) -- (La); \draw[red,dotted] (C2) -- (Lb);
  \draw[blue,very thick] (5.62,0.86) -- (5.80,1.04);
\end{tikzpicture}
