...
\newcommand{\camprojscene}{%
  ...
  % Optical ray from the camera centre through the image plane to the feature
  \draw[thin,gray!70] (0,0) -- (1.05,0.70);
  % Image plane (blue, tilted parallelogram) carrying the pixel measurement z_c
  \draw[blue,thick] (1.05,0.70) -- (2.05,1.02) -- (1.85,1.72) -- (0.85,1.40) -- cycle;
  \fill[blue] (1.50,1.18) circle (1.3pt);
  \node[blue,right=1pt] at (1.52,1.12) {$\vect{z}_c$};
  \node[above] at (1.00,1.66) {\footnotesize Image plane};
  % Feature point P_f
  \fill (5.05,3.00) circle (1.6pt);
  \node[above right] at (5.05,3.00) {$\vect{P}_f$};
  % C-frame sight line to the feature: ^C p_f
  \draw[dashed] (1.55,1.20) -- (5.05,3.00);
...
\begin{tikzpicture}[>=stealth,scale=1.0]
  ...
  % foot point P_pi and normal n_pi
  \coordinate (O) at (0,0);
  \coordinate (P) at (2.0,1.7);
  \draw[dashed] (O) -- (P);
  \node[below right] at (1.0,0.85) {$d_\pi$};
  \fill (P) circle (1.2pt); \node[right] at (2.05,1.62) {$\vect{P}_\pi$};
  \draw[->,thick] (P) -- ($(P)+(0.62,0.88)$) node[above] {$\vect{n}_\pi$};
\end{tikzpicture}
...
\begin{tikzpicture}[>=stealth,scale=1.0]
  % plane
  \draw[thick] (1.9,2.7) -- (3.7,1.15);
  \coordinate (P) at (2.86,1.88);
  \fill (P) circle (1.3pt); \node[above right] at (P) {$\vect{P}_\pi$};
  \draw[->,thick] (P) -- ($(P)+(0.55,0.64)$) node[above] {$\vect{n}$};
  % camera frame {C} (small triad)
  \fill (0,0) circle (1.2pt);
  \draw[->] (0,0) -- (0.55,0.30); \draw[->] (0,0) -- (-0.18,0.55);
  \node[below] at (0,-0.05) {$\{C\}$};
  \draw[dashed] (0,0) -- (P); \node[above left] at (1.50,1.02) {${}^{C}d_\pi$};
  % IMU frame {I} (small green triad, rigidly attached)
  \fill[green!55!black] (1.65,0.30) circle (1.2pt);
  \draw[->,green!55!black] (1.65,0.30) -- (2.15,0.62);
  \draw[->,green!55!black] (1.65,0.30) -- (1.45,0.82);
  \node[green!55!black,below] at (1.72,0.06) {$\{I\}$};
  \draw[dotted,thick] (1.65,0.30) -- (P); \node[below right] at (2.22,1.06) {${}^{I}d_\pi$};
\end{tikzpicture}
...
\begin{tikzpicture}[>=stealth,scale=1.2]
  ...
  \draw[->] (0,0) -- (2.6,0.2) node[right] {$y$};
  \draw[->] (0,0) -- (-1.2,-0.9) node[below left] {$x$};
  \fill (0,0) circle (1.2pt);
  % plane through line and origin (faint triangle)
  \coordinate (A) at (0.55,1.55);
  \coordinate (B) at (2.05,1.95);
  \draw[gray!55] (0,0) -- (A) -- (B) -- cycle;
  % the line L (red)
  \draw[red,very thick] (A) -- (B);
  \coordinate (M) at (1.30,1.75);
  % direction v_e (along the line)
  \draw[->,thick,blue] (M) -- ($(M)+(0.85,0.23)$) node[right] {$\vect{v}_e$};
  % normal n_e (out of the plane)
  \draw[->,thick,blue] (M) -- ($(M)+(0.35,0.95)$) node[above] {$\vect{n}_e$};
  % third axis <n_e>x v_e
  \draw[->,thick,blue] (M) -- ($(M)+(-0.65,-0.55)$) node[left] {\footnotesize $\skewsym{\vect{n}_e}\vect{v}_e$};
  % distance d_L from origin to line
  \draw[dashed] (0,0) -- (M); \node[below right] at (0.55,0.80) {$d_L$};
\end{tikzpicture}
...
\begin{tikzpicture}[>=stealth,scale=1.0]
  ...
  % image plane
  \draw[blue,thick] (0.9,0.3) rectangle (2.3,1.5);
  % plane through line and origin (triangle)
  \draw[gray!55] (0,0) -- (1.3,2.1) -- (2.7,2.4) -- cycle;
  % the line L on the far plane (red)
  \draw[red,very thick] (1.3,2.1) -- (2.7,2.4);
  % its projection onto the image plane (red dotted)
  \draw[red,dotted,thick] (1.1,0.6) -- (2.2,1.05);
  % normal n_e
  \draw[->,thick] (2.0,2.25) -- (2.45,2.95) node[above] {$\vect{n}_e$};
  \node[red] at (3.0,2.3) {$L$};
\end{tikzpicture}
