...
\newcommand{\skewsym}[1]{\left\lfloor#1\times\right\rfloor}
...
%
% One \section per lecture. Add \input lines here as lectures are added.
\input{sections_main/01_lecture01}



%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Append our bibliography (no citations yet -- enable once references are added)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
