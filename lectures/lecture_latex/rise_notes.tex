...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
\input{sections_main/00_titlepage}
%
% One \section per lecture, each starting on a fresh page. Add \input lines here as lectures are added.
\input{sections_main/01_lecture01}
\clearpage
\input{sections_main/02_lecture02}
\clearpage
\input{sections_main/03_lecture03}
\clearpage
\input{sections_main/04_lecture04}
\clearpage
\input{sections_main/05_lecture05}
\clearpage
\input{sections_main/06_lecture06}
\clearpage
\input{sections_main/07_lecture07}
